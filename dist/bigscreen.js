    ...
    (function() {
      ...
      if (this.captionsData.length) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          __out.push(__sanitize(track.language));
...
window.JST["bigscreen/templates/caption_layer"] = function (__obj) {
  ...
  (function() {
    (function() {
      __out.push('<div class="bigscreen-caption-layer">\n  <div class="bigscreen-caption-content">\n  </div>\n</div>\n');
...
window.JST["bigscreen/templates/fullscreen_control"] = function (__obj) {
  ...
  (function() {
    (function() {
      __out.push('<a class="bigscreen-fullscreen-control">Toggle Fullscreen</a>\n');
...
window.JST["bigscreen/templates/pause_button"] = function (__obj) {
  ...
  (function() {
    (function() {
      __out.push('<a class="bigscreen-pause-button">Pause</a>\n');
...
window.JST["bigscreen/templates/play_button"] = function (__obj) {
  ...
  (function() {
    (function() {
      __out.push('<a class="bigscreen-play-button">Play</a>\n');
...
window.JST["bigscreen/templates/tv"] = function (__obj) {
  ...
  (function() {
    (function() {
      __out.push('<div class="bigscreen-layers">\n  ');
    
      __out.push(this.captionLayer.render());
    
      __out.push('\n</div>\n\n<div class="bigscreen-controls">\n  ');
    
      __out.push(this.playButton.render());
    
      __out.push('\n  ');
    
      __out.push(this.pauseButton.render());
    
      __out.push('\n  ');
    
      __out.push(this.progressControl.render());
    
      __out.push('\n  ');
    
      if (this.playbackRateControl) {
        __out.push('\n    ');
        __out.push(this.playbackRateControl.render());
        __out.push('\n  ');
      }
    
      __out.push('\n  ');
    
      __out.push(this.captionControl.render());
    
      __out.push('\n  ');
    
      __out.push(this.fullscreenControl.render());
