describe "Bigscreen.PlayButton", ->
  ...
  describe "#wasPlayed", ->
    ...
    it "adds the 'bigscreen-is-playing' class to the container", ->
      el = $(video.parentNode)
  ...
  describe "#wasPaused", ->
    ...
    it "removes the 'bigscreen-is-playing' class from the container", ->
      el = $(@video.parentNode).addClass('bigscreen-is-playing')
